        ...
        for tries in range(TRIES):
            ...
            try:
                ...
                try: #try to fetch the hostname
                    #Fill in start
                    sourceHost = gethostbyaddr(addr[0])[0]
                    #Fill in end
                except herror:   #if the host does not provide a hostname
                    #Fill in start
                    sourceHost = "hostname unreturnable"
                    #Fill in end
                ...
                if types == 11:
                    ...
                    tracelist1.append([rtt, delay, str(addr[0]), sourceHost])
                    ...
                    delay = str(round(timeSent - timeReceived) * 1000)
                    tracelist1.append([delay, rtt, str(addr[0]), sourceHost])
                    tracelist2.append(tracelist1[-1])
                    return tracelist2
                    #Fill in end
                else:
